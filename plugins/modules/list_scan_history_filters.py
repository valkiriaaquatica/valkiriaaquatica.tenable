...
DOCUMENTATION = r"""
---
module: list_scan_history_filters
short_description: List filters for scan history.
version_added: "0.0.1"
description:
  - This module list filters for scan histories.
  ...
  - Module made from https://developer.tenable.com/reference/io-filters-scan-history-list docs.
author:
...
- name: List scan history filters with enviroment creds
  list_scan_history_filters:
"""
...
def main():
    ...
    endpoint = "filters/scans/reports/history"
