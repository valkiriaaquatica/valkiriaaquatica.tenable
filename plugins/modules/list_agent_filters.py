...
DOCUMENTATION = r"""
---
module: list_agent_filters
short_description: List filters for agents
version_added: "0.0.1"
description:
  - This module list filters for agents
  ...
  - Module made from https://developer.tenable.com/reference/io-filters-agents-list docs.
author:
...
EXAMPLES = r"""
- name: List agent filters
  list_agent_filters:
      access_key: "{{ tenable_access_key }}"
      secret_key: "{{ tenable_secret_key }}"

- name: List agent filters with enviroment creds
  list_agent_filters:
"""
