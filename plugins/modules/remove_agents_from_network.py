...
DOCUMENTATION = r"""
---
module: remove_agents_from_network
short_description: Creates a bulk operation task to remove agents from a group.
version_added: "0.0.1"
description:
  - This module creates a bulk operation task to remove agents from a group.
  - Requires SCAN MANAGER [40] user permissions as specified in the Tenable.io API documentation.
  - This module was made with https://developer.tenable.com/reference/bulk-remove-agents docs.
options:
  network_uuid:
    description:
...
EXAMPLES = r"""
- name: Remove agents to a group filtering
  remove_agents_from_network:
...
- name: Remove agents to a group using enviroment creds and no filters
  remove_agents_from_network:
    network_uuid: "123456789"
    items: ["12345", "65789"]
"""
...
def main():
    argument_spec = get_spec("access_key", "secret_key", "criteria", "network_uuid", "items", "not_items")
    module = AnsibleModule(argument_spec=argument_spec, supports_check_mode=False)
    endpoint = "scanners/null/agents/_bulk/removeFromNetwork"
