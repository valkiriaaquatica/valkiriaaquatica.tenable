...
DOCUMENTATION = r"""
---
module: list_asset_filters
short_description: List filters for assets
version_added: "0.0.1"
description:
  - This module list possible filters for assets
  - Lists the filtering, sorting, and pagination capabilities available for asset records on endpoints that support them
  - Requires BASIC  [16] user permissions as specified in the Tenable.io API documentation.
  - Module made from https://developer.tenable.com/reference/io-filters-assets-list docs.
author:
