...
DOCUMENTATION = r"""
---
module: list_report_filters
short_description: List  filters for report.
version_added: "0.0.1"
description:
  - This module list filters for reports
  ...
  - Module made from https://developer.tenable.com/reference/vm-filters-reports-list docs.
author:
...
EXAMPLES = r"""
- name: List report filters
  list_report_filters:
      access_key: "{{ tenable_access_key }}"
      secret_key: "{{ tenable_secret_key }}"

- name: List report file filters with enviroment creds
  list_report_filters:
"""
...
def main():
    ...
    endpoint = "filters/reports/export"
