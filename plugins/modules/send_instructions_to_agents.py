...
DOCUMENTATION = r"""
---
module: send_instructions_to_agents
short_description: Create instructions for agents to perform.
version_added: "0.0.1"
description:
  - This module creates instructions for agents to perform, including restarting or changing local product settings.
  - Requires SCAN MANAGER [40] user permissions as specified in the Tenable.io API documentation.
  - This module es hecho de https://developer.tenable.com/reference/io-agent-bulk-operations-directive docs.
author:
...
EXAMPLES = r"""
- name: Send restart instructions to agents
  send_instructions_to_agents:
...
- name: Send settings instructions to agents using environment creds
  send_instructions_to_agents:
    criteria:
      filters: ["core_version:lt:10.0.0"]
      filter_type: "and"
...
def main():
    argument_spec = get_spec("access_key", "secret_key", "criteria", "items", "not_items", "directive")
    module = AnsibleModule(argument_spec=argument_spec, supports_check_mode=False)
    endpoint = "scanners/null/agents/_bulk/directive"
