...
DOCUMENTATION = r"""
---
module: list_network_scanners
short_description: Lists all scanners and scanner groups belonging to the specified network object.
version_added: "0.0.1"
description:
  - This module lists all scanners and scanner groups belonging to the specified network object.
  - The module is made from https://developer.tenable.com/reference/networks-list-scanners .
  - Requires ADMINISTRATOR [64] user permissions as specified in the Tenable.io API documentation.
options:
  network_id:
    description:
      - The UUID of the network object for which you want to list assigned scanners and scanner group.
    required: true
    type: str
author:
...
EXAMPLES = r"""
- name: List network  scanners from a network using enviroment creds
...
def main():
    ...
    endpoint = f"networks/{module.params['network_id']}/scanners"
