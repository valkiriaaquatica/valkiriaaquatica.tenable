...
DOCUMENTATION = r"""
---
module: list_credential_filters
short_description: List filters for credentials
version_added: "0.0.1"
description:
  - This module list filters for credentials
  - Lists the filtering, sorting, and pagination capabilities available for credential records on endpoints that support them
  - Requires BASIC [16] user permissions as specified in the Tenable.io API documentation.
  - Module made from https://developer.tenable.com/reference/io-filters-credentials-list docs.
author:
