...
DOCUMENTATION = r"""
---
module: list_asset_tag_filters
short_description: Returns a list of asset tag filters
version_added: "0.0.1"
description:
  ...
  - ncludes the field or tag names to match, the operators that you can use with the filter.
  - Requires BASIC [16] user permissions as specified in the Tenable.io API documentation.
  - Module made from https://developer.tenable.com/reference/tags-list-asset-filters docs.
author:
