...
DOCUMENTATION = r"""
---
module: check_agent_operation_status
short_description: Check the status of a bulk operation on agents.
version_added: "0.0.1"
description:
  - This module checks the status of a bulk operation on agents.
  - Requires SCAN MANAGER [40] user permissions as specified in the Tenable.io API documentation.
  - This module is made from https://developer.tenable.com/reference/bulk-task-agent-status docs.
options:
  task_uuid:
    description:
...
EXAMPLES = r"""
- name: Check the status of a bulk operation on agents
  check_agent_operation_status:
    access_key: "{{ tenable_access_key }}"
    secret_key: "{{ tenable_secret_key }}"
    task_uuid: "321"

- name: Check the status of a bulk operation on agents using environment creds
  check_agent_operation_status:
    task_uuid: "321"
"""
...
def main():
    ...
    endpoint = f"scanners/null/agents/_bulk/{module.params['task_uuid']}"
