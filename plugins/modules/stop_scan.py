...
---
module: stop_scan
short_description: Stops a scan.
version_added: "0.0.1"
description:
  - This module  stops a scan.
  - You can only stop a scan that has a status of pending, running, or resuming
  - To stop a scan with a status of stopping or publishing, use the forc_stop_scan module.
  - The module is made from https://developer.tenable.com/reference/scans-stop docs.
...
def main():
    ...
    endpoint = f"scans/{module.params['scan_id']}/stop"
