...
import pytest
from ansible_collections.valkiriaaquatica.tenable.plugins.modules.list_remediation_scans import main
from ansible_collections.valkiriaaquatica.tenable.tests.unit.constants import BASE_MODULE_PATH


@pytest.fixture
def mock_module():
    with patch(BASE_MODULE_PATH + "list_remediation_scans.AnsibleModule", autospec=True) as mock:
        yield mock


def test_list_remediation_scans(mock_module):
    ...
    with patch(BASE_MODULE_PATH + "list_remediation_scans.run_module") as mock_run_module, patch(
        BASE_MODULE_PATH + "list_remediation_scans.build_query_parameters"
        ...
        assert called_args[1] == "scans/remediation"
