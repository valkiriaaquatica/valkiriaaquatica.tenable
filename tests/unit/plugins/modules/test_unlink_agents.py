...
import pytest
from ansible_collections.valkiriaaquatica.tenable.plugins.modules.unlink_agents import main
from ansible_collections.valkiriaaquatica.tenable.tests.unit.constants import BASE_MODULE_PATH


@pytest.fixture
def mock_module():
    with patch(BASE_MODULE_PATH + "unlink_agents.AnsibleModule", autospec=True) as mock:
        yield mock


def test_unlink_agents(mock_module):
    ...
    with patch(
        BASE_MODULE_PATH + "unlink_agents.build_payload", return_value=expected_payload
    ) as mock_build_payload, patch(BASE_MODULE_PATH + "unlink_agents.run_module") as mock_run_module:
        main()
        ...
        assert called_args[1] == "scanners/null/agents/_bulk/unlink"
